...
function Hospital() {
  ...
  // Comprehensive Indian hospital data with real coordinates
  const hospitals = [
    // Delhi NCR
    { 
      name: "AIIMS Delhi", 
      ...
      emergency: true,
      image: "https://images.unsplash.com/photo-1587351021759-3772687fe598?w=400&h=300&fit=crop",
      lat: 28.5672,
      lng: 77.2100,
      established: "1956",
      beds: 2500,
    ...
    { 
      ...
      emergency: true,
      image: "https://images.unsplash.com/photo-1632833232315-4f1d5c9a7c8d?w=400&h=300&fit=crop",
      lat: 19.1176,
      lng: 72.8333,
      established: "2008",
      beds: 750,
    ...
    { 
      ...
      emergency: true,
      image: "https://images.unsplash.com/photo-1598301257982-0b0141c60fd1?w=400&h=300&fit=crop",
      lat: 19.0544,
      lng: 72.8254,
      established: "1997",
      beds: 350,
        ...
        {results.length > 0 && (
          <>
            ...
            <div className="flex justify-center gap-2 mb-6">
              {[
                { type: "all", label: "All Hospitals" },
                { type: "emergency", label: "🚑 Emergency" },
                { type: "high-rated", label: "⭐ High Rated (4.5+)" }
              ].map((filter) => (
                <button
                  key={filter.type}
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredResults.map((hospital, index) => (
                  ...
                  >
                    ...
                    {/* Hospital details */}
                    <div className="p-6">
                      <h3 className="text-xl font-bold text-[#088395] mb-2">
                        {hospital.name}
                      </h3>
                      ...
                      <div className="flex gap-2">
                        <a
                          ...
                          className="flex-1 bg-[#088395] text-white px-4 py-2 rounded-lg text-sm hover:bg-[#09637E] transition-colors text-center"
                        >
                          Contact
                        </a>
                        <button
                          onClick={() => showHospitalMap(hospital)}
                          className="flex-1 border-2 border-[#088395] text-[#088395] px-4 py-2 rounded-lg text-sm hover:bg-[#088395] hover:text-white transition-colors"
                        >
                          View Map
                        </button>
                      </div>
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="mt-2 block text-center text-sm text-[#088395] hover:underline"
                      >
                        Visit Website →
                      </a>
                    </div>
